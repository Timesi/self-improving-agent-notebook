const n=`{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "Beta(α, β) 是定义在 (0,1) 上的分布，用来刻画一个未知的成功率。α 可以理解为成功次数加 1，β 是失败次数加 1，分布均值是 α/(α+β)。\\n",
    "\\n",
