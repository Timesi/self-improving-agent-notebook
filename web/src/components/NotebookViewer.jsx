...
function NotebookViewer({ notebook, meta, loading, isBookmarked, toggleBookmark, notes, saveNote, deleteNote, updateNoteSection }) {
  ...
  const drawShareCard = (quote, notebookTitle) => {
    ...
    accentGrad.addColorStop(1, 'rgba(99, 102, 241, 0.6)')
    ...
    logoGrad.addColorStop(0, 'rgba(124, 58, 237, 0.12)')
    logoGrad.addColorStop(1, 'rgba(99, 102, 241, 0.12)')
    ...
    ctx.fillText('Self-Improving Agent', logoX + 48, logoY + 16)
    ...
    ctx.fillText('self-improving-agent-notebook.github.io', P, footY + 4)

    // Right side: small "Share" label
    ctx.textAlign = 'right'
    ctx.fillText('Made with Self-Improving Agent Notebook', W - P, footY + 4)
    ctx.textAlign = 'left'
