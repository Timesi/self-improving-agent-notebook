...
const SECTION_KEYS = ['foundation', 'training', 'engineering', 'frontiers']
const SECTION_LABELS = {
  foundation: { title: '基础与方法', titleEn: 'FOUNDATION' },
  training: { title: '训练与进化', titleEn: 'TRAINING & EVOLUTION' },
  engineering: { title: '智能体工程', titleEn: 'AGENT ENGINEERING' },
    ...
    <aside ref={asideRef} className={`w-64 h-screen max-h-screen border-r flex flex-col justify-between shrink-0 z-30 transition-transform duration-300 ${
      ...
      <div ref={headerRef} className="p-6 border-b shrink-0 flex flex-col gap-4 z-10 select-none border-[var(--border-light)]">
        <div className="flex items-center justify-between">
          <button onClick={onHome} className="brand-button" aria-label="Self-Improving Agent Notebook">
            <span className="brand-logo" aria-hidden="true">
              <GitFork className="brand-logo-fork" />
              <Code2 className="brand-logo-code" />
            </span>
            <span className="brand-copy">
              <span className="brand-line brand-line-main">Self-Improving</span>
              <span className="brand-line brand-line-sub">Agent</span>
            </span>
          </button>
      ...
      {isCompactFooter ? (
        <div ref={footerRef} className="shrink-0 border-t flex items-center justify-around gap-1 border-[var(--border-light)] bg-[var(--bg-sidebar-footer)] px-2 py-2">
          ...
          <a href="https://github.com/walkinglabs/self-improving-agent-notebook" target="_blank" rel="noreferrer"
